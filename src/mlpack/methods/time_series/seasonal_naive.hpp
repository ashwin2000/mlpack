...
/**
 * @file mothods/time_series_models/seasonal_naive.hpp
 * @author Ashwin
 *
 * Definition of the Seasonal Naive Model for time series data.
 *
 ...
 */
#ifndef MLPACK_METHODS_TIME_SERIES_MODELS_SEASONAL_NAIVE_MODEL_HPP
#define MLPACK_METHODS_TIME_SERIES_MODELS_SEASONAL_NAIVE_MODEL_HPP
